...
export default function Contactus() {
  return (
    <>
      <div
        className="lg:flex justify-center items-center bg-cover bg-center bg-no-repeat py-6  gap-6"
        style={{
      ...
      >
        <form className="bg-white bg-opacity-80 p-6 rounded-lg shadow-md w-full max-w-md">
